...
class WatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create water" do
    assert_difference('Water.count') do
      post waters_url, params: { water: { feeling: @water.feeling, intensity: @water.intensity } }
    end
  ...
  test "should update water" do
    patch water_url(@water), params: { water: { feeling: @water.feeling, intensity: @water.intensity } }
